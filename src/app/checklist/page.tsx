...
export default function page() {
  ...
  return (
    <MainLayout className="bg-[#F0F5FB] px-4 py-10 pb-22">
      <div className="flex flex-col gap-2">
        <TitleXl>집 보기 전, 꼭 확인할 항목을 체크하세요!</TitleXl>
        <BodyXl className="text-neutral-70">별표 표시한 항목은 체크리스트 상단에 고정돼요.</BodyXl>
      </div>
                  ...
                  if (favoriteItems.length === 0) {
                    return (
                      <div className="flex w-full flex-col items-center py-6">
                        <TitleXs className="text-neutral-70">'이것만큼은 꼭!' 하는 항목에</TitleXs>

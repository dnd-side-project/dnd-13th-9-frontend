...
import { CurrentLocationOverlay } from './CurrentLocationOverlay';
  ...
  return (
    <div className={className}>
      <div
        ...
        className="min-h-0"
      />
      {/* Declarative current-location overlay */}
      ...
      <button
        type="button"
        onClick={locate}
        className="absolute top-6 right-[18px] z-10 rounded-full bg-white shadow-md"
        aria-label="현재 위치로 이동"
      >
        <Icon
          name="currentLocation"
          size={22}
          color={isAwayFromUser ? 'neutral' : 'black'}
          padding={10}
        />
      </button>
    </div>
